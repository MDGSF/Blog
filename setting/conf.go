...
func settingGlobalVariables() {
	...
	AppVersion = beego.AppConfig.DefaultString("app::AppVersion", "1.0.0.1")
	AppAuthor = beego.AppConfig.DefaultString("app::AppAuthor", "author")
	AppAuthorEmail = beego.AppConfig.DefaultString("app::AppAuthorEmail", "xxx@email.com")
	AppAuthorGitHub = beego.AppConfig.DefaultString("app::AppAuthorGitHub", "")
	AppAuthorTwitter = beego.AppConfig.DefaultString("app::AppAuthorTwitter", "")
	AppAuthorFacebook = beego.AppConfig.DefaultString("app::AppAuthorFacebook", "")

	PostDirectory = beego.AppConfig.Strings("app::PostDirectory")
	PostAuthor = beego.AppConfig.DefaultString("app::PostAuthor", "author")
	PostAbstractionLen = beego.AppConfig.DefaultInt("app::PostAbstractionLen", 100)

	HTTPAddr = beego.AppConfig.DefaultString("httpaddr", "127.0.0.1")
	HTTPPort = beego.AppConfig.DefaultInt("httpport", 8080)
	AppHost = beego.AppConfig.DefaultString("listen::app_host", "127.0.0.1:8080")
